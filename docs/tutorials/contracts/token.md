...
We have pre-built a template for this tutorial hosted on **this link gives white page:[near.dev](https://examples.near.org/token-contract-as)** called "Token Contract in AssemblyScript". You can try running the application right away to see the code interacting with the blockchain -- just click **Open in Gitpod**.
